package in.indilabz.flutter_runtime_permission;
...
public class FlutterRuntimePermissionPlugin implements MethodCallHandler, PluginRegistry.RequestPermissionsResultListener {
    private Registrar registrar;
    private Result result;

    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "indilabz.in/permission");
        FlutterRuntimePermissionPlugin permissionPlugin = new FlutterRuntimePermissionPlugin(registrar);
        channel.setMethodCallHandler(permissionPlugin);
        registrar.addRequestPermissionsResultListener(permissionPlugin);
    }

    private FlutterRuntimePermissionPlugin(Registrar registrar) {
